...
namespace RestClientSDKLibrary
{
    ...
    public partial class RestClientSDKLibraryClient : ServiceClient<RestClientSDKLibraryClient>, IRestClientSDKLibraryClient
    {
        ...
        /// </return>
        public async Task<HttpOperationResponse<object>> CreateTaskWithHttpMessagesAsync(TasksCreatePayload body = default(TasksCreatePayload), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (body != null)
            {
               /// body.Validate(); removed
            }
            // Tracing
            ...
            if ((int)_statusCode == 201)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<TaskResult>(_responseContent, this.DeserializationSettings);
                }
        ...
        public async Task<HttpOperationResponse<object>> GetAllTasksWithHttpMessagesAsync(string orderByDate = "asc", string taskStatus = "all", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<TasksResults>(_responseContent, this.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<object>> UpdateTaskWithHttpMessagesAsync(long id, TasksCreatePayload body = default(TasksCreatePayload), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
            ...
            cancellationToken.ThrowIfCancellationRequested();
            string _responseContent = null;
            if ((int)_statusCode != 204 && (int)_statusCode != 400 && (int)_statusCode != 403 && (int)_statusCode != 409 && (int)_statusCode != 404)
            {
                var ex = new HttpOperationException(string.Format("Operation returned an invalid status code '{0}'", _statusCode));
                _responseContent = await _httpResponse.Content.ReadAsStringAsync().ConfigureAwait(false);
                ex.Request = new HttpRequestMessageWrapper(_httpRequest, _requestContent);
